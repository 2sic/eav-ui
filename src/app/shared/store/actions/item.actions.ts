...
export class AddItemAttributeAction implements Action {
    ...
    constructor(public id: number, public attribute: EavValues<any>, public attributeKey: string, public headerGuid: string) { }
}

export class AddItemAttributeValueAction implements Action {
    readonly type = ADD_ITEM_ATTRIBUTE_VALUE;
    constructor(public id: number, public attributeValue: EavValue<any>, public attributeKey: string, public headerGuid: string) { }
}
...
export class AddItemAttributeDimensionAction implements Action {
    ...
    constructor(public id: number, public attributeKey: string, public dimensionValue: string,
        public existingDimensionValue: string, public defaultLanguage: string, public isReadOnly: boolean, public headerGuid: string) { }
}
...
export class UpdateItemAction implements Action {
    ...
    constructor(public attributes: EavAttributes, public id: number, public headerGuid: string) { }
}
...
export class UpdateItemAttributeValueAction implements Action {
    ...
    constructor(public id: number, public attributeKey: string, public attributeValue: string,
        public existingLanguageKey: string, public defaultLanguage: string, public isReadOnly: boolean, public headerGuid: string) { }
}
...
export class UpdateItemAttributesValuesAction implements Action {
    ...
    constructor(public id: number, public updateValues: { [key: string]: any },
        public existingLanguageKey: string, public defaultLanguage: string, public headerGuid: string) { }
}
...
export class RemoveItemAttributeDimensionAction implements Action {
    ...
    constructor(public id: number, public attributeKey: string, public dimensionValue: string, public headerGuid: string) { }
}
/**
 * Delete
 */
