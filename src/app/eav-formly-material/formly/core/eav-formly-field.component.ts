...
import { FormlyConfig, Field, FormlyFieldConfig, FormlyFormOptions } from '@ngx-formly/core';// TypeOption,TemplateManipulators
import { TypeOption, TemplateManipulators } from '@ngx-formly/core/src/services/formly.config';
...
export class EavFormlyField implements OnInit, OnChanges, OnDestroy {
  @Input() model: any;
