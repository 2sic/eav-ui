...
import { FormlyFieldConfig, FormlyFormOptions, FormlyFormBuilder } from '@ngx-formly/core';
...
@Component({
    selector: 'eav-formly-form',
    template: `
    <eav-formly-field *ngFor="let field of fields"
...
export class EavFormlyForm implements DoCheck, OnChanges {
    @Input() model: any = {};
    ...
    constructor(
        ...
        @Optional() @SkipSelf() private parentFormlyForm: EavFormlyForm,
    ) { }
