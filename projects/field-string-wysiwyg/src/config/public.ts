...
export const ImgEnhancedAlignLeft = `${WysiwygClassPrefix}-img-left`;
export const ImgEnhancedAlignCenter = `${WysiwygClassPrefix}-img-center`;
export const ImgEnhancedAlignRight = `${WysiwygClassPrefix}-img-right`;
