...
1. carefully copy styles from `"src/assets/2sxc-tinymce-skin/content/content.css"` to `"src/field-string-wysiwyg/tinymce-content.scss"`. Check comments
...
1. fix what you don't like in `"src/field-string-wysiwyg/skin-overrides.scss"`
