...
const configuration = {
  ...
  entry: [
    ...
    './projects/field-string-wysiwyg/src/field-string-wysiwyg/field-string-wysiwyg-preview.ts',
    './projects/field-string-wysiwyg/src/field-string-wysiwyg/field-string-wysiwyg-editor.ts',
  ],
  plugins: [
