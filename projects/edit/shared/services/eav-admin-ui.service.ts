...
export class EavAdminUiService {
  ...
  public openItemEditWithEntityId(dialog: MatDialog, component: any, entityId: string) {
    return <MatDialogRef<any, any>>(
      this.openModalDialog(dialog, component, entityId, null, DialogTypeConstants.itemEditWithEntityId, null)
    );
  }
