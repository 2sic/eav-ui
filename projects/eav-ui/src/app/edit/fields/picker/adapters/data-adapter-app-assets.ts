...
export class DataAdapterAppAssets extends DataAdapterEntityBase {
  ...
  log = classLog({DataAdapterAppAssets}, logSpecsDataAdapterEntityBase, true) as ClassLogger<typeof DataAdapterBase.logSpecs> & ClassLogger<typeof logSpecsDataAdapterEntityBase>;
