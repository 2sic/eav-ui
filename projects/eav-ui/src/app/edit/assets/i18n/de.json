{
  "Form": {
    "Buttons": {
      ...
      "CreateAndClose": "Erstellen und schliessen",
      "ActionAndCloseShortcut": "Tastenkürzel: ctrl + enter",
  ...
  "Message": {
    ...
    "FindOutMore": "mehr",
    "NoDataBundles": "Keine Entität oder kein Inhalt für Datenpakete gefunden. Bitte wählen Sie eine Entität oder einen Inhalt im MetaData Export Decorator aus."
  },
  "LangMenu": {
  ...
  "ValidationMessage": {
    ...
    "Min": "Dieser Wert sollte mindestens {{Min}} sein",
    "Max": "Dieser Wert sollte höchstens {{Max}} sein",
    "Pattern": "Bitte richtig eingeben",
    "Decimals": "Diese Zahl kann {{Decimals}} Dezimalstellen haben",
  ...
  "Fields": {
    "Picker": {
      ...
      "FilterNoResults": "keine Treffer bei der suche nach '{{search}}'",
    ...
    "DateTime": {
      ...
      "OpenCalender": "Kalendar öffnen",
      "OpenTime": "Zeit wählen"
    },
    "String": {
  ...
  "Extension.TinyMce": {
    ...
    "Splitter.0": "Trennung ohne Lücke, damit der nächste Inhalt auf einer neuen Zeile beginnt",
    "Splitter.s": "Trennung mit kleiner Lücke",
    "Splitter.m": "Trennung mit mittelgrosser Lücke",
    "Splitter.l": "Trennung mit grosser Lücke"
  },
  "Features": {
    "NotActivated": "Die Funktion '{{name}}' ist nicht aktiviert - mehr erfahren"
  },
  "License-EditUi-Warning-Label": "Vorschau",
  "License-EditUi-Warning-Tooltip": "Du verwendest Funktionen, die nicht lizenziert sind.",
  "LanguageSettings": {
    "Title": "Spracheinstellungen (BETA)",
    "Intro": "Standardmässig verwenden Schaltflächen und Beschriftungen die aktuelle Sprache. Hier können Sie ein anderes Verhalten wählen.",
    "Subtitle": "Ihre Spracheinstellungen",
    "UseCurrentLanguage": "Aktuelle Sprache verwenden (Standard)",
    "ButtonsAndControlsOptionLabel": "Schaltflächen und Steuerelemente",
    "ButtonsAndControlsTooltip": "Bevorzugte Sprache für Schaltflächen und Steuerelemente",
    "LabelsAndTextsOptionLabel": "Formularbeschriftungen und Hilfetexte",
    "LabelsAndTextsTooltip": "Bevorzugte Sprache für Texte und Beschriftungen in Formularen",
    "TranslatePrimaryOptionLabel": "Sprachmenus in Hauptsprache anzeigen",
    "TranslatePrimaryTooltip": "Zeigt die Sprachmenüs auch in der Hauptsprache an",
    "ActivatedOption": "Aktiviert",
    "DeactivatedOption": "Deaktiviert"
  }
}
